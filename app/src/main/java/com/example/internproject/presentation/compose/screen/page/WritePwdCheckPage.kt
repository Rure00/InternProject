...
fun WritePwdCheckPage(
    ...
    val pwdCheckState = remember { mutableStateOf(value) }
    ...
    fun validatePwdCheck() {
        val result = (pwdCheckState.value == pwd)
        ...
        if(result) {
            ...
            warningMsg.value = "비밀번호가 일치하지 않습니다."
        }
    }
